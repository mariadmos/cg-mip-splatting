...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        # Ablacao: quando True, zera o filtro 3D de suavizacao (novidade 1 do paper).
        # Combinado com kernel_size, permite reproduzir variantes de baseline no mesmo codigo.
